...
<div class="flex flex-col flex-nowrap justify-center xl:flex-row xl:flex-wrap h-feed">
  <div
    ...
    class="flex-1 w-full max-w-screen-md xl:order-last mx-auto xl:mr-0 xl:ml-8 xl:max-w-md">
    <Profile />
  </div>
  <div
    in:fly={{ x: -25, duration: 300, delay: 500 }}
    out:fly={{ x: -25, duration: 300 }}
    class="flex-1 w-full max-w-screen-md order-first mx-auto xl:ml-0 xl:mr-8 xl:max-w-md">
  ...
  <div class="flex-none w-full max-w-screen-md mx-auto xl:mt-8">
    {#key posts}
